...
- (void)onVmaxEventWithEvent_name:(NSString * _Nonnull)event_name param:(NSDictionary<NSString *, NSString *> * _Nonnull)param;
- (void)onDeenSDKRCFailedWithRC_Code:(NSString * _Nonnull)RC_Code;
@end

SWIFT_CLASS("_TtC12DeenIslamSDK21DeenWebViewController")
@interface DeenWebViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
...
@interface DeenWebViewController (SWIFT_EXTENSION(DeenIslamSDK)) <WKScriptMessageHandler>
...
@class WKNavigation;
@interface DeenWebViewController (SWIFT_EXTENSION(DeenIslamSDK)) <WKNavigationDelegate>
